...
class InstagramAPI(oauth2.OAuth2API):
    ...
    media_search = bind_method(
                path="/media/search",
                accepts_parameters=['lat', 'lng', 'min_timestamp', 'max_timestamp', 'distance', 'count'],
                root_class=Media)
    ...
    user_media_feed = bind_method(
                ...
                accepts_parameters=['max_id', 'min_id', 'count'],
                root_class=Media,
                paginates=True)
    ...
    user_recent_media = bind_method(
                ...
                accepts_parameters=['user_id', 'max_id', 'min_id', 'count', 
    ...
    location_recent_media = bind_method(
                ...
                accepts_parameters=['location_id', 'max_id', 'min_id', 'min_timestamp', 'max_timestamp'],
                root_class=Media,
                paginates=True)

    location_search = bind_method(
                path="/locations/search",
                accepts_parameters=['lat', 'lng', 'foursquare_v2_id', 'distance'],
                root_class=Location)
    ...
    geography_recent_media = bind_method(
                ...
                accepts_parameters=["geography_id", 'min_id', 'count'],
                root_class=Media,
                paginates=True)

    tag_recent_media = bind_method(
                path="/tags/{tag_name}/media/recent",
                accepts_parameters=['tag_name', 'count', 'max_tag_id', 'min_tag_id'],
                root_class=Media,
                paginates=True)
